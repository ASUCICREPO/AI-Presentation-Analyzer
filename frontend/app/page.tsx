...
import { AIFeedbackResponse, QAAnalyticsResponse, pollQAAnalytics } from './services/api';
...
export default function Home() {
  ...
  const resolveAnalyticsAndShow = useCallback(async () => {
    ...
    // Fetch QA analytics (generated by agentcore, may take a few seconds)
    const qaResult = await pollQAAnalytics(sessionId);
